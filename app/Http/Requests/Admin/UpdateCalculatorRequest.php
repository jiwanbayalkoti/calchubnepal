...
class UpdateCalculatorRequest extends FormRequest
{
    ...
    {
        $calculator = \App\Models\Calculator::find($this->route('id'));

        return $calculator !== null && $this->user() !== null && $this->user()->can('update', $calculator);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['nullable', 'string', 'max:255', Rule::unique('calculators', 'slug')->ignore($this->route('id'))],
