 ...
 * Density Converter
 */
class DensityConverter extends AbstractCalculatorHandler
{
  ...
  'lb_ft3' => 16.0185,
    ...
    public function inputSchema(): array
    {
        ...
        return [
            ...
            $this->field('from_unit', 'From Unit', 'select', ['options' => array_combine($units, $units), 'default' => 'kg_m3']),
            $this->field('to_unit', 'To Unit', 'select', ['options' => array_combine($units, $units), 'default' => 'g_cm3']),
        ];
    }
