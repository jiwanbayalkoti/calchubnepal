...
class AiPromptSeeder extends Seeder
{
    ...
    protected const PROMPTS = [
        ...
        [
            ...
            'prompt_template' => "Write an SEO-friendly blog post titled \"{{title}}\" targeting the primary keyword \"{{keyword}}\".\nRelated calculator: {{calculator_title}}\n\nRequirements: 700-900 words, use H2/H3 subheadings in Markdown, include a short intro and a practical conclusion with a call to action to try the {{calculator_title}}. Write in a clear, helpful, non-repetitive tone suitable for a general audience.",
            'model' => 'gpt-4o',
            'provider' => 'openai',
            'temperature' => 0.70,
            'max_tokens' => 1800,
