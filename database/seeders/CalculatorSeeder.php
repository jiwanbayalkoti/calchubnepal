...
class CalculatorSeeder extends Seeder
{
    ...
    protected const CALCULATOR_META = [
        ...
        // sip_calculator meta: Database\Seeders\Content\SipCalculatorSeoContent (merged at runtime).
        ...
        foreach ($registry->all() as $key => $handler) {
            ...
            $calculator = Calculator::query()->updateOrCreate(
                ...
                [
                    ...
                    'formula_expression' => $meta['formula_expression'] ?? null,
                    'input_schema' => $schema,
    ...
    protected function seedExample(
        ...
        CalculatorExample::query()->create([
            ...
            'inputs' => $inputs,
            'outputs' => $outputs,
            'explanation' => $explanation ?: 'This example uses typical sample values. Adjust the inputs above to see how the results change for your own numbers.',
            'sort_order' => 1,
        ]);
