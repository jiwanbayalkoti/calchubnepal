...
class CalculatorSeeder extends Seeder
{
    ...
    protected const CATEGORIES = [
        ...
        [
            ...
            'icon' => 'fas fa-car',
            'sort_order' => 12,
            'description' => 'Fuel cost, mileage, tire size, EV charging and road-trip planning calculators.',
            'meta_title' => 'Automobile Calculators - Fuel, Mileage, EV | Calculator Hub',
            'meta_description' => 'Free automobile calculators for fuel cost, mileage, tire size, EV charging and trip cost.',
        ],
        [
            'slug' => 'agriculture',
