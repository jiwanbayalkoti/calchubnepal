...
<head>
    ...
    @php
        $advSeo = app(\App\Services\Seo\SeoService::class);
        $advCanonical = $advSeo->normalizeCanonical(url()->current());
        $advTitle = trim($__env->yieldContent('title', 'Dashboard')).' | Advertiser Portal';
    @endphp
    <title>{{ $advTitle }}</title>
    <meta name="robots" content="noindex,follow">
    <meta name="description" content="Private advertiser portal — not for public indexing.">
    <link rel="canonical" href="{{ $advCanonical }}">
    <meta property="og:title" content="{{ $advTitle }}">
    <meta property="og:url" content="{{ $advCanonical }}">
